...
// planteenlo dentro de una función, que la función reciba como parámetro el montoALlevar
let IGV = 1.18;
let descuento = 0;
let montoNumerico = prompt("Cuanto llevará el/la cliente?");
let montoNumerico = parseFloat(ontoNumerico);
function calcularPrecioTotal(montoNumerico){
    if(montoNumerico > 300){
        descuento = 60;
    }else if(montoNumerico > 150){
        descuento = 20;
...
calcularPrecioTotal(montoNumerico);