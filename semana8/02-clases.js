...
class Personaje {
    ...
    // es el primer metodo que se va a ejecutar
    ...
    set fuerza(nuevaFuerza){
        ...
        if (typeof nuevaFuerza !== "number"){
            ...
            return;// retorna un valor, corta la ejecucion de la funcion
        }
...
const robot1 = new Bot("Charizard", 120, 150, 45, 35, 160, "facil");
